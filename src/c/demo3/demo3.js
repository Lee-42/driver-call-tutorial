...
// 加载共享库
const myComplexLibrary = ffi.Library('./libmycomplexlibrary', {
...
myComplexLibrary.processArrayWithCallback(ref.alloc('int', arr[0]), arr.length, ffi.Callback('void', ['int'], printElement));
// 输出：
// Element: 1
// Element: 2
// Element: 3
